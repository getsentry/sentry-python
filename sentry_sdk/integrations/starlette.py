...
def _capture_exception(exception: BaseException, handled: bool = False) -> None:
...
class StarletteRequestExtractor:
    ...
    def extract_cookies_from_request(self) -> "Optional[Dict[str, Any]]":
    ...
    async def extract_request_info(self) -> "Optional[Dict[str, Any]]":
