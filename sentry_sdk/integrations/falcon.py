...
def _patch_handle_exception() -> None:
    ...
    def sentry_patched_handle_exception(self: "Any", *args: "Any") -> "Any":
...
def _exception_leads_to_http_5xx(ex: Exception, response: "Any") -> bool:
...
def _has_http_5xx_status(response: "Any") -> bool:
