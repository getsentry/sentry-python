...
def _patch_run_single_turn_streamed():
    ...
    agents.run.AgentRunner_run_single_turn_streamed = patched_run_single_turn_streamed


def _patch_execute_handoffs():
...
def _patch_execute_final_output():
    ...
    agents._run_impl.RunImpl.execute_final_output = patched_execute_final_output
