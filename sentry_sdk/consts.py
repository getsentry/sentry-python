...
class ClientConstructor:
    ...
    def __init__(
        ...
        *,
        ...
        enable_http_query_source=True,  # type: bool
        http_query_source_threshold_ms=0,  # type: int
        ...
        :param enable_http_query_source: When enabled, the source location will be added to outgoing HTTP requests.

        :param http_query_source_threshold_ms: The threshold in milliseconds for adding the source location to HTTP
            requests.

            The query location will be added to the request for requests slower than the specified threshold.
