    ...
    def __init__(
        ...
        *,
        ...
        :param release: Sets the release.
            ...
            See [the releases documentation](/platforms/python/configuration/releases/) to learn how the SDK tries to
            ...
            identify the potential source in [the product documentation](/product/releases/).
        ...
        :param max_breadcrumbs: This variable controls the total amount of breadcrumbs that should be captured.
            ...
            However, you should be aware that Sentry has a [maximum payload size](https://develop.sentry.dev/sdk/
            data-model/envelopes/#size-limits) and any events exceeding that payload size will be dropped.
        ...
        :param send_default_pii: If this flag is enabled, [certain personally identifiable information (PII)](/platforms/
            python/data-management/data-collected/) is added by active integrations.
            
            If you enable this option, be sure to manually remove what you don't want to send using our features for
            managing [_Sensitive Data_](../../data-management/sensitive-data/).
        ...
        :param event_scrubber: Scrubs the event payload for sensitive information such as cookies, sessions, and
            ...
            See how to [configure the scrubber here](../../data-management/sensitive-data/#event-scrubber).
        ...
        :param integrations: List of integrations to enable in addition to [auto-enabling integrations](/platforms/
            python/integrations).
        ...
        :param disabled_integrations: List of integrations that will be disabled.
            ...
            This setting can be used to explicitly turn off specific [auto-enabling](/platforms/python/integrations/
            #available-integrations) or [default](/platforms/python/integrations/default-integrations/) integrations.

        :param auto_enabling_integrations: Configures whether [auto-enabling integrations](/platforms/python/
            integrations/#available-integrations) should be enabled.
        ...
        :param default_integrations: Configures whether [default integrations](/platforms/python/integrations/
            default-integrations/) should be enabled.
        ...
        :param proxy_headers: A dict containing additional proxy headers (usually for authentication) to be forwarded
            to `urllib3`'s [`ProxyManager`](https://urllib3.readthedocs.io/en/1.24.3/reference/index.html#urllib3.
        ...
        :param socket_options: An optional list of socket options to use.
            ...
            If provided, the options will override the default `urllib3` [socket options](https://urllib3.readthedocs.
            io/en/stable/reference/urllib3.connection.html#urllib3.connection.HTTPConnection).
        ...
        :param functions_to_trace: An optional list of functions that should be set up for tracing.
            ...
            To learn more, see the [Custom Instrumentation](/platforms/python/tracing/instrumentation/
            custom-instrumentation/#define-span-creation-in-a-central-place) documentation.
        ...
        :param custom_repr: A custom [repr](https://docs.python.org/3/library/functions.html#repr) function to run
