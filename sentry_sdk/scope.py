...
class Scope:
    ...
    __slots__ = (
        ...
        "_agent_framework_generation_entered",
        "_session",
        "_attachments",
    ...
    def __init__(
        ...
        self._agent_framework_generation_entered : "bool" = False
    ...
    def __copy__(self) -> "Scope":
        ...
        rv._agent_framework_generation_entered  = self._agent_framework_generation_entered 
