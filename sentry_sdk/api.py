...
def capture_event(
    ...
    **scope_wkargs  # type: Any
    ...
    # type: (...) -> Optional[str]
    return Hub.current.capture_event(event, hint, scope=scope, **scope_wkargs)
...
def capture_message(
    ...
    **scope_wkargs  # type: Any
    ...
    # type: (...) -> Optional[str]
    return Hub.current.capture_message(message, level, scope=scope, **scope_wkargs)
...
def capture_exception(
    ...
    **scope_wkargs  # type: Any
    ...
    # type: (...) -> Optional[str]
    return Hub.current.capture_exception(error, scope=scope, **scope_wkargs)
