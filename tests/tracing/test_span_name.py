...
def test_start_span_name(sentry_init, capture_events):
    ...
    with sentry_sdk_alpha.start_span(name="hi"):
        with sentry_sdk_alpha.start_span(op="foo", name="span-name"):
            ...
...
def test_start_child_name(sentry_init, capture_events):
    ...
    with sentry_sdk_alpha.start_span(name="hi"):
        with sentry_sdk_alpha.start_span(op="foo", name="span-name") as span:
