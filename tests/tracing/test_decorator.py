...
from sentry_sdk.tracing_utils_python3 import (
    start_child_span_decorator as start_child_span_decorator_python3,
)
...
def test_trace_decorator_sync_py3():
    ...
    with mock.patch(
        "sentry_sdk.tracing_utils_python3._get_transaction",
        ...
        result2 = start_child_span_decorator_python3(my_example_function)()
...
async def test_trace_decorator_async_py3():
    ...
    with mock.patch(
        ...
        result2 = await start_child_span_decorator_python3(my_async_example_function)()
        fake_start_child.assert_called_once_with(
            op="function", description="test_decorator.my_async_example_function"
        )
...
async def test_trace_decorator_async_py3_no_trx():
    ...
    with mock.patch(
        ...
        with mock.patch.object(logger, "warning", mock.Mock()) as fake_warning:
            ...
            result2 = await start_child_span_decorator_python3(
