...
from sentry_sdk.tracing_utils_python2 import (
    start_child_span_decorator as start_child_span_decorator_python2,
)
...
def test_trace_decorator_py2():
    ...
    with mock.patch(
        "sentry_sdk.tracing_utils_python2._get_transaction",
        ...
        result2 = start_child_span_decorator_python2(my_example_function)()
        fake_start_child.assert_called_once_with(
            op="function", description="test_decorator_python2.my_example_function"
        )
    ...
    with mock.patch(
        ...
        with mock.patch.object(logger, "warning", mock.Mock()) as fake_warning:
            ...
            fake_warning.assert_called_once_with(
                ...
                "test_decorator_python2.my_example_function",
            )
            assert result2 == "return_of_sync_function"
