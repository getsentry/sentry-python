...
@pytest.mark.forked
def test_cache_spans_middleware(sentry_init, client, settings, capture_events):
    settings.CACHES = {
        "default": {
...
@pytest.mark.forked
def test_cache_spans_disabled_middleware(sentry_init, client, settings, capture_events):
    settings.CACHES = {
        "default": {
            "BACKEND": "django.core.cache.backends.locmem.LocMemCache",
            "LOCATION": "unique-snowflake",
...
def test_cache_spans_decorator(sentry_init, client, settings, capture_events):
    settings.CACHES = {
        "default": {
            "BACKEND": "django.core.cache.backends.locmem.LocMemCache",
            "LOCATION": "unique-snowflake",
...
def test_cache_spans_disabled_decorator(sentry_init, client, settings, capture_events):
    settings.CACHES = {
        "default": {
            "BACKEND": "django.core.cache.backends.locmem.LocMemCache",
            "LOCATION": "unique-snowflake",
...
def test_cache_spans_templatetag(sentry_init, client, settings, capture_events):
    settings.CACHES = {
        "default": {
            "BACKEND": "django.core.cache.backends.locmem.LocMemCache",
            "LOCATION": "unique-snowflake",
...
def test_cache_spans_disabled_templatetag(
    sentry_init, client, settings, capture_events
):
    settings.CACHES = {
        "default": {
            "BACKEND": "django.core.cache.backends.locmem.LocMemCache",
