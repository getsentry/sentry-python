...
async def test_outgoing_trace_headers_append_to_baggage(
    ...
    with start_transaction(
        ...
        assert (
            ...
            == "custom=value,sentry-trace_id=0123456789012345678901234567890,sentry-environment=production,sentry-release=d08ebdb9309e1b004c6f52202de58a09c2268e42,sentry-transaction=/interactions/other-dogs/new-dog,sentry-sample_rate=1.0,sentry-sampld=true"
        )
