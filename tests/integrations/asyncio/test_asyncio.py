...
from sentry_sdk_alpha.integrations.asyncio import AsyncioIntegration, patch_asyncio
...
async def test_create_task(
    ...
    with sentry_sdk_alpha.start_span(name="test_transaction_for_create_task"):
        with sentry_sdk_alpha.start_span(op="root", name="not so important"):
...
async def test_gather(
    ...
    with sentry_sdk_alpha.start_span(name="test_transaction_for_gather"):
        with sentry_sdk_alpha.start_span(op="root", name="not so important"):
...
async def test_exception(
    ...
    with sentry_sdk_alpha.start_span(name="test_exception"):
        sentry_sdk_alpha.get_isolation_scope().set_transaction_name("test_exception")
        with sentry_sdk_alpha.start_span(op="root", name="not so important"):
...
async def test_span_origin(
    ...
    with sentry_sdk_alpha.start_span(name="something"):
        tasks = [
